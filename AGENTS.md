...
3. Check D:\projects\dev-system_system\incidents\INCIDENT-LOG.md before debugging.
4. Check D:\projects\dev-system_system\knowledge\INDEX.md before building integrations.
5. If you discover a reusable pattern, gotcha, or solution: write it to D:\projects\dev-system_system\librarian\intake\ (see SYSTEM.md for format).
